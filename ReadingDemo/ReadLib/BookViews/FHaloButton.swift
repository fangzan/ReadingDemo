...
class FHaloButton: UIControl {
    ...
    class func HaloButtonSize(_ size:CGSize) ->CGSize {
        ...
        return CGSize(width: size.width + FSpace_5, height: size.height + FSpace_5)
    }
    ...
    private func setFrame() {
        ...
        // 布局
        imageView.frame = CGRect(x: FSpace_4, y: FSpace_4, width: width - FSpace_5, height: height - FSpace_5)
        
        // 圆角
        imageView.layer.cornerRadius = (width - FSpace_5) / 2
    }
